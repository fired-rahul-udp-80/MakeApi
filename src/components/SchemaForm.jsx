...
const SchemaForm = ({ setSchema,theme }) => {
  ...
  return (
    <div className={`flex flex-col gap-y-2 mx-auto p-4 bg-white shadow rounded ${theme == "light" ? "dark:bg-slate-900 backdrop-blur-md" : " dark:bg-gray-800"} dark:text-white`}>
